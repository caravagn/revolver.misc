...
We can also plot the phylogenetic trees for this patient.
```{r}
plot(phylo, patients = 'CRUK0002')
```

**Output file:** ["CRUK0002.pdf"](./CRUK0002.pdf) 

<!-- ## Analysis, fitting the models -->

<!-- <!-- In the current release we make available an S3 object that contains the pre-computed phylogenies for the TRACERx cohort. --> -->
<!-- <!-- ```{r} --> -->
<!-- <!-- data(TRACERx.cohort) --> -->
<!-- <!-- print(TRACERx.cohort) --> -->
<!-- <!-- ``` --> -->

<!-- We have computed offline the phylogenetic trees for this cohort with the above parameters -->

Once the analysis has been carried out, one can assess confidence of the estimates with the jackknife; see the CRC vignette attached to REVOLVER for an example. We suggest running these analyses on a cluster machine to speed up the computation (on a 40-core machines jackknife analysis requires ~30 minutes exploiting 90% of the available cores in parallel).
